...
PopupLayer* PopupLayer::create(const char *backgroundImage){
	...
	cocos2d::CCRect centerRect = cocos2d::CCRectMake(0, 0, 100, 100);
	ml->setSprite9BackGround(CCScale9Sprite::scale9SpriteWithFile(backgroundImage, centerRect));
	return ml;
}
...
void PopupLayer::onEnter(){
	...
	cocos2d::Vector<cocos2d::CCNode *> array = getMenuButton()->getChildren();
	...
	for (auto sp : array)
	{
		...
		CCNode* node = dynamic_cast<CCNode*>(sp);
