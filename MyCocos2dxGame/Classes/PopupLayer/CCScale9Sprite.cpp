...
CCScale9Sprite::CCScale9Sprite(const char* file, const CCRect & centreRegion) {
	...
	scale9Image = CCSpriteBatchNode::create(file, 9);
	...
	//centre = CCSpriteBatchNode::createSpriteWithRect(scale9Image, centreRegion);
	centre = CCSprite::createWithTexture(scale9Image->getTexture());
	centre->setPosition(CCPointMake((centreRegion.origin.x + centreRegion.size.width) / 2.0f, (centreRegion.origin.y + centreRegion.size.height) / 2.0f));
	...
	*/
	top = CCSprite::createWithTexture(scale9Image->getTexture());
	top->setPosition(CCPointMake(centreRegion.origin.x, 0));
	...
	*/
	bottom = CCSprite::createWithTexture(scale9Image->getTexture());
	bottom->setPosition(CCPointMake(centreRegion.origin.x, centreRegion.origin.y + centreRegion.size.height));
	...
	*/
	left = CCSprite::createWithTexture(scale9Image->getTexture());
	left->setPosition(CCPointMake(0, centreRegion.origin.y));
    ...
    */
	right = CCSprite::createWithTexture(scale9Image->getTexture());
	right->setPosition(CCPointMake(centreRegion.origin.x + centreRegion.size.width, centreRegion.origin.y));
	...
	*/
	topLeft = CCSprite::createWithTexture(scale9Image->getTexture());
	topLeft->setPosition(CCPointMake(0, 0));
	...
	*/
	topRight = CCSprite::createWithTexture(scale9Image->getTexture());
	topRight->setPosition(CCPointMake(centreRegion.origin.x + centreRegion.size.width, 0));
	...
	*/
	bottomLeft = CCSprite::createWithTexture(scale9Image->getTexture());
	bottomLeft->setPosition(CCPointMake(0, centreRegion.origin.y + centreRegion.size.height));
	...
	*/
	bottomRight = CCSprite::createWithTexture(scale9Image->getTexture());
	bottomRight->setPosition(CCPointMake(centreRegion.origin.x + centreRegion.size.width, centreRegion.origin.y + centreRegion.size.height));
...
void CCScale9Sprite::setColor(ccColor3B var)
{
	...
	if (scale9Image->getChildrenCount())
	{
		CCObject* child;
		/*
