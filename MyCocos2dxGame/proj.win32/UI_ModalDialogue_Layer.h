#pragma once
/*
@example: UI_ModalDialogue_Layer::DoModal("321","4343",UI_ModalDialogue_Layer::DT_Yes_No,[&](){this->foo();} );
*/
...
class UI_ModalDialogue_Layer : public cocos2d::extension::Control
{
public:
